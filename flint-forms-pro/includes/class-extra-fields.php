...
class Extra_Fields {
	...
	public function register( $fields ) {
		$fields->register(
			'rating',
			array(
				'label'  => __( 'Star Rating', 'flint-forms-pro' ),
		...
		$fields->register(
			'range',
			array(
				'label'  => __( 'Range Slider', 'flint-forms-pro' ),
		...
		$fields->register(
			'password',
			array(
				'label'  => __( 'Password', 'flint-forms-pro' ),
				'icon'   => 'dashicons-lock',
				'group'  => 'pro',
				'pro'    => true,
		...
		$fields->register(
			'section',
			array(
				'label'  => __( 'Section Divider', 'flint-forms-pro' ),
		...
		$fields->register(
			'pagebreak',
			array(
				'label'  => __( 'Page Break', 'flint-forms-pro' ),
				'icon'   => 'dashicons-flag',
				'group'  => 'pro',
				'pro'    => true,
	...
	public function render_pagebreak( $field ) {
		$next = isset( $field['next_label'] ) && $field['next_label'] ? $field['next_label'] : __( 'Next', 'flint-forms-pro' );
		$prev = isset( $field['prev_label'] ) && $field['prev_label'] ? $field['prev_label'] : __( 'Previous', 'flint-forms-pro' );
		return sprintf(
