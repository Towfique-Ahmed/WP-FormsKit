...
class Payments {
	...
	public function register_field( $fields ) {
		$fields->register(
			'payment',
			array(
				'label'  => __( 'Payment (Stripe)', 'flint-forms-pro' ),
	...
	public function settings_fields( $settings ) {
		?>
		<tr>
			<th scope="row"><?php esc_html_e( 'Stripe Publishable Key', 'flint-forms-pro' ); ?></th>
		...
		<tr>
			<th scope="row"><?php esc_html_e( 'Stripe Secret Key', 'flint-forms-pro' ); ?></th>
