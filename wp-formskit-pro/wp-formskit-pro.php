<?php
/**
 * Plugin Name:       WP FormsKit Pro
 * Plugin URI:        https://wpformskit.com/pro/
 * Description:       Supercharges WP FormsKit with conditional logic, multi-step forms, file uploads, reCAPTCHA, integrations and Stripe payments. Requires WP FormsKit.
 * Version:           1.0.0
 * Requires at least: 6.0
 * Requires PHP:      7.4
 * Requires Plugins:  wp-formskit
 * Author:            WP FormsKit
 * Author URI:        https://wpformskit.com/
 * License:           GPL-2.0-or-later
 * License URI:       https://www.gnu.org/licenses/gpl-2.0.html
 * Text Domain:       wp-formskit-pro
	...
	function () {
		...
		add_action(
			...
			function () {
				...
				echo esc_html__( 'WP FormsKit Pro requires the free WP FormsKit plugin to be installed and active.', 'wp-formskit-pro' );
				echo '</p></div>';
			}
		);
	},
