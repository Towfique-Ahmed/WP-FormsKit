...
class Settings {
	...
	public static function render_page() {
		...
		<div class="wrap formskit-settings">
			<h1><?php esc_html_e( 'WP FormsKit Settings', 'wp-formskit' ); ?></h1>
			...
			<form method="post" action="options.php">
				...
				<table class="form-table" role="presentation">
					<tr>
						<th scope="row"><?php esc_html_e( 'Delete data on uninstall', 'wp-formskit' ); ?></th>
						<td>
							<label>
								...
								<?php esc_html_e( 'Permanently remove all forms and entries when the plugin is deleted.', 'wp-formskit' ); ?>
							</label>
						</td>
					</tr>
			...
			<?php if ( ! \FormsKit\is_pro() ) : ?>
				<div class="formskit-upsell">
					<h2><?php esc_html_e( 'Unlock more with WP FormsKit Pro', 'wp-formskit' ); ?></h2>
					<p><?php esc_html_e( 'Conditional logic, multi-step forms, file uploads, reCAPTCHA, Stripe payments and integrations — all your free features stay included.', 'wp-formskit' ); ?></p>
				</div>
			<?php endif; ?>
		</div>
		<?php
