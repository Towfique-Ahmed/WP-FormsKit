=== Flint Forms — Contact Form & Form Builder ===
...
**Flint Forms** is a modern, lightweight form builder for WordPress. Build a form
...
= Go further with Flint Forms Pro =

Flint Forms Pro keeps **all** the free features and adds:
...
1. Upload the `flint-forms` folder to `/wp-content/plugins/`, or install through
   the Plugins screen in WordPress.
2. Activate **Flint Forms** through the *Plugins* menu.
...
reCAPTCHA/hCaptcha, upgrade to Flint Forms Pro.
...
= 1.0.0 =
Initial release of Flint Forms.
